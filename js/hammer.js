...
function Hammer(element, options, undefined)
{
    ...
    // support Firefox OS simulator
    var pf = navigator.platform.toLocaleLowerCase();
    var ua = navigator.userAgent.toLocaleLowerCase();
    var isFirefoxOsSimulator
        = ((pf.indexOf('macintel') !== -1)  // (Mac OS
        || (pf.indexOf('win') !== -1))      //   or Windows OS)
        && (ua.indexOf('firefox') !== -1)   // and Firefox browser
        && (ua.indexOf('mobile') !== -1)    // and mobile browser
        && (ua.indexOf('android') === -1);  // and not android
    if (isFirefoxOsSimulator) {
        _has_touch = false;
    }
